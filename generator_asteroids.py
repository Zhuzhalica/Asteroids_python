...
class Generator:
    ...
    def make_new_asteroid(self):
        start_position = (pygame.math.Vector2(-10, random.randint(-10, self.screen.get_rect().bottom)), pygame.math.Vector2(self.screen.get_rect().right + 10, random.randint(-10, self.screen.get_rect().bottom)))
